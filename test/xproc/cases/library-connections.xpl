...
<p:library xmlns:s="x-urn:test:xproc:steplibrary" xmlns:p="http://www.w3.org/ns/xproc"
    ...
    <p:declare-step type="s:no-input-two-options-one-output">
        ...
        <p:add-attribute attribute-name="attr2" attribute-value="{$attrval2}"/>
    </p:declare-step>

    <!-- Several variations on s:two-inputs-no-option-one-output are for testing inheritance in x:call -->
    <p:declare-step type="s:two-inputs-no-option-one-output-altcomp" name="two-inputs-no-option-one-output-altcomp">
    ...
    <p:declare-step type="s:two-inputs-no-option-one-output-altname" name="two-inputs-no-option-one-output-altname">
    ...
    <p:declare-step type="s:two-inputs-no-option-one-output-altpos" name="two-inputs-no-option-one-output-altpos">
    ...
    <p:declare-step type="s:three-inputs-no-option-one-output" name="three-inputs-no-option-one-output">
