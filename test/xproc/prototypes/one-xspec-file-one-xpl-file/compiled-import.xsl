...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            ...
            <xsl:sequence xmlns:ex="x-urn:example:xproc"
                          ...
                          select="Q{x-urn:example:xproc}process($Q{urn:x-xspec:compile:impl}param-d570e1)"/>
         </xsl:variable>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1-expect1"
      ...
      <xsl:variable xmlns:ex="x-urn:example:xproc"
                    xmlns:x="http://www.jenitennison.com/xslt/xspec"
                    name="Q{urn:x-xspec:compile:impl}expect-d566e6"
                    select="$Q{urn:x-xspec:compile:impl}expect-d566e6-doc ! ( $x:result?result )"><!--expected result--></xsl:variable>
